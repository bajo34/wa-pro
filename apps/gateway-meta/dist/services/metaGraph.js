...
export function validateSignature(rawBody, signatureHeader) {
...
export async function replyToCommentPublic(commentId, message) {
 ...
 */
export async function privateReplyToComment(commentId, message) {
