  ...
  private envProcess(): Env {
    return {
      SERVER: {
        ...
        // Railway (and similar PaaS) commonly injects PORT.
        // Keep SERVER_PORT as the primary key, but fall back to PORT for compatibility.
      ...
      CORS: {
        // Some deployments set only CORS="*"; keep CORS_ORIGIN as the primary key.
        ORIGIN: (process.env.CORS_ORIGIN || process.env.CORS)?.split(',') || ['*'],
        METHODS:
